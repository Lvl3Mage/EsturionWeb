...
function InitializeSliders() {
  ...
  $(".banner-slider").slick({
    ...
    dotsClass: 'absolute top-[70px] sm:top-[calc(100%_-_60px)] sm:z-10 right-0 left-0 h-8 *:p-3 md:*:p-1 flex justify-center md:items-center gap-2 *:[&.slick-active]:*:outline-white sm:*:[&.slick-active]:*:outline-gold *:hover:*:brightness-90 *:rounded-full overflow-hidden',
    customPaging: function (slider, i) {
